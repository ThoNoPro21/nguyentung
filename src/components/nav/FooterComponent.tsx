...
const FooterComponent = (props: Props) => {
    return (
        <div className="relative p-0 m-0">
            ...
            <div className="relative w-full h-52 lg:h-100 bg-[url('/assets/bg-footer.jpg')] bg-cover bg-center -z-10">
            </div>
            <div className="absolute top-0 left-0 w-full h-full text-white">
                <Flex justify='space-evenly' align='center' className=' h-full flex-col-reverse md:flex-row' >
                    <div>
                        <p className='font-normal text-sm'>  © 2024 ,Bản quyền thuộc về <span className='text-yellow-500 text-lg font-mono font-bold'>Nguyễn Tuyên</span> </p>
                    </div>
                    <Flex className='cursor-pointer'>
                        <Popover content="Nguyễn Tuyên" >
                            <div className="facebook-icon ">
                                <Link href='https://www.facebook.com/profile.php?id=61561616887727&mibextid=ZbWKwL' target='_blank'>
                        ...
                        <Popover content="Nguyễn Tuyên" >
                            <Link href='https://www.tiktok.com/@nguyentuyen3889?_t=8ntWA6sFeaI&_r=1' target='_blank'>
                        ...
                        <div className="youtube-icon text-white">
                            <Link href='https://youtube.com/@nguyentuyen789?si=4owfN_Y_v0tdamhB' target='_blank'>
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48" color='white'>
