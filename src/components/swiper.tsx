            ...
            <SwiperSlide>
                <div className="h-full bg-gray-100 rounded-md px-4 py-2 flex flex-col">
                    <p className='flex-1'>
                        ...
                        Hãy nắm bắt cơ hội này để biến giấc mơ kinh doanh của bạn thành hiện thực. Hãy vào Youtube và TikTok cả Facebook <span className="text-lg text-cyan-600">Nguyễn Tuyên</span> follow theo dõi những livestream vào lúc 20h Hàn Quốc va 22h Việt Nam.
                    </p>
