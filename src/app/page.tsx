            ...
            <div className="relative bg-[url('/assets/bg.jpg')] bg-cover bg-center w-full h-screen flex items-center justify-center">
                <div className="flex flex-col text-center">
                    <p className="text-3xl font-bold max-w-96 ">
                        Biến Đổi Cuộc Đời Nhờ Internet: Câu Chuyện Của <span className="font-mono text-5xl text-yellow-700" >Nguyễn Tuyên</span>
                    </p>

                    <span className="text-lg font-normal font-mono">
                        Chàng trai từ công nhân trở thành kỹ sư xây dựng và kinh doanh trên Internet.
                    </span>
                </div>
            </div>
                ...
                <div className="flex flex-col md:flex-row pt-5 gap-4">
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="max-w-96">Trước khi trở thành kỹ sư xây dựng và kinh doanh trên Internet tại Hàn Quốc, Tuyên nói rằng mình đã trải qua giai đoạn đầy bão tố, khiến anh trở nên im lặng và mất phương hướng.Giai đoạn đầy bão tố
                            Sinh ra trong một gia đình nghèo ở vùng quê, những gì hằn sâu trong tuổi thơ của Nguyên Văn Tuyên (1991) đều lạc hậu và vất vả. Từ nhỏ, gia đình kinh tế khó khăn, cha mẹ cũng áp lực bủa vây vì tiền ăn học của mấy chị em.
                            khi ấy, Tuyên không nhận thức được vấn đề.Đến cuối cấp 3, Tuyên nhận ra vấn đề là phải đi làm kiếm nhiều tiền cho cha mẹ.
                            Năm 2009, Tuyên bắt đầu đi xuất khẩu lao động ở Đài Loan. Tới năm 2012, Tuyên đã đặt chân đến và làm việc tại Hàn Quốc.</p>
                    </div>
                </div>
                <div className="flex flex-col md:flex-row pt-5 gap-4 ">
                    <div className="flex flex-col ">
                        <h1 className="text-2xl font-bold">Giai Đoạn Tìm Kiếm Cơ Hội Tại Hàn Quốc</h1>
                        <p className="max-w-96">
                            Lý do khiến tôi rời quê hương để đến Hàn Quốc tìm kiếm cơ hội không chỉ đơn thuần là khát vọng về một cuộc sống tốt đẹp hơn, mà còn là mong muốn học hỏi và phát triển trong một môi trường mới. Hàn Quốc, với nền công nghiệp xây dựng phát triển và nhiều dự án lớn, đã hứa hẹn mang lại cho tôi những kinh nghiệm quý báu và cơ hội thăng tiến trong sự nghiệp.Nhưng điều làm tôi luôn cảm thấy day dứt nhất chính là gia đình nhỏ bé ở quê hương Việt Nam.
                            Mỗi lần gọi điện về nhà, nghe giọng nói của vợ và con, tôi lại cảm thấy lòng mình như chùng xuống.
                            Những khoảnh khắc quan trọng trong cuộc sống của con, tôi đã bỏ lỡ; những buổi chiều tối gia đình quây quần bên nhau, tôi không thể có mặt. Mẹ cha già yếu vẫn ngày ngày ngóng trông tin con, mong đợi ngày tôi trở về. Những lá thư từ quê nhà, những lời động viên và sự chờ đợi của gia đình.
                        </p>
                    </div>
                    <Image src="/assets/anh2.jpg" alt="avatar" width={1000} height={1000} className="w-96 h-auto rounded-sm" />
                </div>
